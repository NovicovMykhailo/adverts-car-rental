export default function smartFilter(data, obj) {
  ...
  return data.filter(item => {
    if (make !== ' ' && make && rentalPrice !== ' ' && rentalPrice && millageTo !== ' ' && millageTo && millageFrom !== ' ' && millageFrom ) {
      ...
      return item.mileage >= `${millageFrom}` &&  item.mileage <= `${millageTo}` && Number(item.rentalPrice.split('$')[1]) <= Number(rentalPrice) &&  item.make === make;
      ...
      return  item.mileage >= `${millageFrom}` && item.mileage <= `${millageTo}` && Number(item.rentalPrice.split('$')[1]) <= Number(rentalPrice);
      ...
      return item.make === make && item.mileage <= `${millageTo}` && Number(item.rentalPrice.split('$')[1]) <= Number(rentalPrice) ; 
      ...
      return item.make === make &&  item.mileage >= `${millageFrom}` && Number(item.rentalPrice.split('$')[1]) <= Number(rentalPrice); 

    } else if (rentalPrice !== ' ' && rentalPrice && millageFrom !== ' ' && millageFrom) {
      //console.log('6 > mileage from and price'); // by make and mileage from
      return item.mileage >= `${millageFrom}` && Number(item.rentalPrice.split('$')[1]) <= Number(rentalPrice) && item.make === make   ; 
   
    } else if (rentalPrice !== ' ' && rentalPrice && millageTo !== ' ' && millageTo) {
      //console.log('7 >  mileage to and price'); // by price and mileage to
      return item.mileage <= `${millageTo}` && Number(item.rentalPrice.split('$')[1]) === rentalPrice; 
      ...
      return Number(item.rentalPrice.split('$')[1]) <= Number(rentalPrice) && item.make === make ; 
